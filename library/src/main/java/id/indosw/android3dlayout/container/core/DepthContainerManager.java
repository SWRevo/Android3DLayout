package id.indosw.android3dlayout.container.core;
...
import id.indosw.android3dlayout.CustomShadow;
...
public class DepthContainerManager {
    ...
    float getLongestHorizontalEdge(DepthLayout dl) {
        ...
        return Math.max(topEdgeLength, bottomEdgeLength);
    }
    ...
    float getLongestVerticalEdge(DepthLayout dl) {
        ...
        return Math.max(leftEdgeLength, rightEdgeLength);
    }
